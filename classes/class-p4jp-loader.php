 ...
 */
final class P4JP_Theme_Loader {
	/**
	 * A static instance of Loader.
	 *
	 * @var P4JP_Theme_Loader $instance
	 */
	 ...
	 *
	 * @return P4JP_Theme_Loader
	 */
	public static function get_instance( $services = [] ) : P4JP_Theme_Loader {
	...
	private function load_files() {
		try {
			...
			spl_autoload_register(
				function ( $class_name ) {
					if ( strpos( $class_name, 'P4JP_Theme' ) !== false ) {
						$file_name = 'class-' . str_ireplace( [ 'p4jp\\', '_' ], [ '', '-' ], strtolower( $class_name ) );
